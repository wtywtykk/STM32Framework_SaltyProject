...
#define FT5336_TOUCH_EVT_FLAG_MASK          ((uint8_t)(0x03 << FT5336_TOUCH_EVT_FLAG_SHIFT))

#define FT5336_TOUCH_ID_FLAG_SHIFT         ((uint8_t)0x04)
#define FT5336_TOUCH_ID_FLAG_MASK          ((uint8_t)(0x0F << FT5336_TOUCH_ID_FLAG_SHIFT))
...
#define FT5336_TOUCH_AREA_MASK              ((uint8_t)(0x0F << FT5336_TOUCH_AREA_SHIFT))
